/** Journey reference catalogue, not a runtime metric mapping or evidence of availability. Item numbers are preserved. */
/**
 * JOURNEY REFERENCE CATALOGUE
...
export const MASTER_TAXONOMY: MetricTaxonomyItem[] = [
  ...
  {
    itemNo: 29,
    formattedItemNo: "Internally Deduplicated Leads - 029.0",
    reportValue: "Internally Deduplicated Leads",
    goal: "WEB Leads & Sales",
    objective: "Conversion",
    okr: "Get as many Deduplicated leads as possible",
    costMetric: "CPL.Deduped",
    metric: "Deduplication rate",
    costMetricFormula: "Spend / Internally Deduplicated Leads",
  ...
  {
    itemNo: 37,
    formattedItemNo: "Dialled Leads - 037.0",
    reportValue: "Dialled Leads",
    goal: "WEB Leads & Sales",
    objective: "Conversion",
    okr: "Get as many leads dialled as possible",
    costMetric: "CPL.Dialed",
    metric: "Lead dial rate",
    costMetricFormula: "Spend / Dialled Leads",
    waterfallMetricFormula: "(Dialled Leads / Qualified Leads) * 100",
  ...
  {
    itemNo: 47,
    formattedItemNo: "Sales Payment Collections - 047.0",
    reportValue: "Sales Payment Collections",
    goal: "WEB Leads & Sales",
    objective: "Post Conversion",
  ...
  },
  {
    ...
    costMetric: "CLTV",
    metric: "Lifetime Value / Acquisition Cost (Reference Ratio)",
    costMetricFormula: "Total Revenue collected / Customer Total Acquisition Cost",
    waterfallMetricFormula: "Customer Lifetime Revenue / Customer Total Acquisition Cost",
    revenueMetric: "ROAS",
    costOfRevenueMetricFormula: "Customer Lifetime Revenue / Customer Total Acquisition Cost",
