...
import { classLabel, colourLabel, countRatio, periodChange, COUNT_KEYS, VETTING_SECTIONS, MISSING_CLASS, MISSING_COLOUR, UNMAPPED_COLOUR, MULTIPLE_COLOURS, type VettingReport } from '../contracts/vetting';
...
const aggregate=(leads='8')=>({...Object.fromEntries(COUNT_KEYS.map(k=>[k,k==='leads'?leads:'0'])),classMeanSeconds:null,colourMeanSeconds:null});
function result(){
