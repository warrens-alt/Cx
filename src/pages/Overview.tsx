...
export default function Overview() {
  ...
  return <PageShell>
    ...
    <div className="space-y-6">
      ...
      <details className="enterprise-card p-4"><summary className="min-h-11 font-semibold">Delivery, activation and conversion details</summary>
      ...
      <details className="enterprise-card p-4" onToggle={event=>setReturnedOpen(event.currentTarget.open)}><summary className="min-h-11 font-semibold">Explore all returned datasets</summary>{returnedOpen&&<DataVisual id="api.response" data={data} context={{endpoint:"overview"}}/>}</details>
    </div>
