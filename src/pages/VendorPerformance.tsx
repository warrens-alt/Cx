...
export default function VendorPerformance() {
  ...
  return <div className="cx-page cx-ops-page">
    ...
    {report&&<>
      ...
      <section className="enterprise-card cx-ops-driver" aria-label="Descriptive driver decomposition"><header><div><p className="cx-ops-eyebrow">Where movement appears</p><h2>{selectedCurrent?.group??'Select a vendor'} · descriptive change signals</h2><p>Signals compare independent measures with the previous period. They are not additive contributions and do not claim causation.</p></div><span className="cx-status">Previous comparable period</span></header>
